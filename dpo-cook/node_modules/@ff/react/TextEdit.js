...
class TextEdit extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("textarea", { key: this.props.text, className: className, style: style, defaultValue: this.props.text, placeholder: placeholder, ref: this.onRef, onChange: this.onChange, onFocus: this.onFocus, onBlur: this.onBlur }));
    }
    onRef(element) {
