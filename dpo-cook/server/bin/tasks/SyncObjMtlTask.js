 ...
 */
class SyncObjMtlTask extends ToolTask_1.default {
...
exports.default = SyncObjMtlTask;
SyncObjMtlTask.taskName = "SyncObjMtl";
SyncObjMtlTask.description = "Ensures a mtl file exists and the obj references it correctly.";
SyncObjMtlTask.parameterSchema = {
    type: "object",
    properties: {
...
SyncObjMtlTask.parameterValidator = Task_1.default.jsonValidator.compile(SyncObjMtlTask.parameterSchema);
//# sourceMappingURL=SyncObjMtlTask.js.map